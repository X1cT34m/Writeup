...
```
![](https://gitee.com/leonsec/images/raw/master/YUeiBbb.png)
...
![](https://gitee.com/leonsec/images/raw/master/4QlcP5y.png)

发现有模板包含加路径穿越，在传入的模板名后拼接`.html`，模板名可控
于是写入php读文件然后包含即可：

![](https://gitee.com/leonsec/images/raw/master/qeq9Job.png)

![](https://gitee.com/leonsec/images/raw/master/77ynN3A.png)
...
![image-20210613013847884](https://gitee.com/leonsec/images/raw/master/image-20210613013847884.png)

拿到shell发现`/flag`需要root权限读取

![image-20210613014251808](https://gitee.com/leonsec/images/raw/master/image-20210613014251808.png)

查看最近修改的文件发现有jboss应用，猜测有jboss服务在本地端口

![img](https://gitee.com/leonsec/images/raw/master/3M]UHSX0J{SPY2UTB%1YHR.png)

信息搜集发现开在了8006端口，于是代理进去访问看到一个1.jsp：

![img](https://gitee.com/leonsec/images/raw/master/RDT4BXT3C4KFOYX4$F0LA`A.png)
...
![image-20210613015409314](https://gitee.com/leonsec/images/raw/master/image-20210613015409314.png)
...
![](https://gitee.com/leonsec/images/raw/master/QQ图片20210613214316.png)
...
![](https://gitee.com/leonsec/images/raw/master/tQbTNZ3.png)
